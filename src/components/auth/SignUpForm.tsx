    ...
    <main className="flex flex-wrap bg-white">
      <section className="flex overflow-hidden flex-col my-auto min-w-[240px] w-[880px] max-md:max-w-full">
        <div className="flex relative flex-col justify-center items-start px-20 py-56 w-full min-h-[960px] max-md:px-5 max-md:py-24 max-md:max-w-full">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/d93c2f28c4b06540f60faecc9173f42078e1bdfc9405fa985f7ae22982374545?apiKey=dcc7f3c8807f4c038c88f79f5b63c9e1&"
            alt=""
            className="object-cover absolute inset-0 size-full"
          />
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/b358347a165fbe4f2a41b427586dbeaf866125b1442625dbbb49c489d94c4781?apiKey=dcc7f3c8807f4c038c88f79f5b63c9e1&"
            alt="Sign up illustration"
            className="object-contain mb-0 max-w-full aspect-[1.23] w-[628px] max-md:mb-2.5"
          />
        </div>
      </section>
      ...
      <section className="flex overflow-hidden flex-col flex-1 shrink justify-center items-center basis-0 min-w-[240px] max-md:max-w-full">
        <div className="flex flex-col justify-center max-w-full w-[456px]">
          <header className="flex flex-col justify-center self-start px-12 max-md:px-5">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/61f9f4efb556098bdede32d2d5060b282810a926196c632098d5acc906b58459?apiKey=dcc7f3c8807f4c038c88f79f5b63c9e1&"
              alt="Company logo"
              className="object-contain max-w-full aspect-[3.37] w-[222px]"
            />
          </header>
